 ...
 */
typedef NS_OPTIONS(NSUInteger, ZWNetworkTrafficType) {
    ZWNetworkTrafficTypeWWANSent     = 1 << 0,
    ZWNetworkTrafficTypeWWANReceived = 1 << 1,
    ZWNetworkTrafficTypeWIFISent     = 1 << 2,
    ZWNetworkTrafficTypeWIFIReceived = 1 << 3,
    ZWNetworkTrafficTypeAWDLSent     = 1 << 4,
    ZWNetworkTrafficTypeAWDLReceived = 1 << 5,
    
    ZWNetworkTrafficTypeWWAN = ZWNetworkTrafficTypeWWANSent | ZWNetworkTrafficTypeWWANReceived,
    ZWNetworkTrafficTypeWIFI = ZWNetworkTrafficTypeWIFISent | ZWNetworkTrafficTypeWIFIReceived,
    ZWNetworkTrafficTypeAWDL = ZWNetworkTrafficTypeAWDLSent | ZWNetworkTrafficTypeAWDLReceived,
    
    ZWNetworkTrafficTypeALL = ZWNetworkTrafficTypeWWAN |
    ZWNetworkTrafficTypeWIFI |
    ZWNetworkTrafficTypeAWDL,
};
