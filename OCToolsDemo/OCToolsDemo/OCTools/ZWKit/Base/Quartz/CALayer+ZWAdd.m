...
ZWSYNTH_DUMMY_CLASS(CALayer_ZWAdd)


@implementation CALayer (ZWAdd)
...
- (UIViewContentMode)contentMode {
    return ZWCAGravityToUIViewContentMode(self.contentsGravity);
}

- (void)setContentMode:(UIViewContentMode)contentMode {
    self.contentsGravity = ZWUIViewContentModeToCAGravity(contentMode);
}
...
- (void)addFadeAnimationWithDuration:(NSTimeInterval)duration curve:(UIViewAnimationCurve)curve {
    ...
    [self addAnimation:transition forKey:@"zwkit.fade"];
}

- (void)removePreviousFadeAnimation {
    [self removeAnimationForKey:@"zwkit.fade"];
}
