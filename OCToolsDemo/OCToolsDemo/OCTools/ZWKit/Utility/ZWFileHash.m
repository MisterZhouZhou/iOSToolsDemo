...
@implementation ZWFileHash

+ (ZWFileHash *)hashForFile:(NSString *)filePath types:(ZWFileHashType)types {
    return [self hashForFile:filePath types:types usingBlock:nil];
}

+ (ZWFileHash *)hashForFile:(NSString *)filePath types:(ZWFileHashType)types usingBlock:(void(^)(UInt64 totalSize, UInt64 processedSize, BOOL *stop))block {
    ZWFileHash *hash = nil;
