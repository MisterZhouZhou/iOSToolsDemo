 ...
 */
@protocol ZWTextViewDelegate <NSObject, UIScrollViewDelegate>
@optional
- (BOOL)textViewShouldBeginEditing:(ZWTextView *)textView;
- (BOOL)textViewShouldEndEditing:(ZWTextView *)textView;
- (void)textViewDidBeginEditing:(ZWTextView *)textView;
- (void)textViewDidEndEditing:(ZWTextView *)textView;
- (BOOL)textView:(ZWTextView *)textView shouldChangeTextInRange:(NSRange)range replacementText:(NSString *)text;
- (void)textViewDidChange:(ZWTextView *)textView;
- (void)textViewDidChangeSelection:(ZWTextView *)textView;

- (BOOL)textView:(ZWTextView *)textView shouldTapHighlight:(ZWTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(ZWTextView *)textView didTapHighlight:(ZWTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
- (BOOL)textView:(ZWTextView *)textView shouldLongPressHighlight:(ZWTextHighlight *)highlight inRange:(NSRange)characterRange;
- (void)textView:(ZWTextView *)textView didLongPressHighlight:(ZWTextHighlight *)highlight inRange:(NSRange)characterRange rect:(CGRect)rect;
@end
 ...
 */
@interface ZWTextView : UIScrollView <UITextInput>
...
@property (nullable, nonatomic, weak) id<ZWTextViewDelegate> delegate;
 ...
 */
@property (nullable, nonatomic, strong) id<ZWTextParser> textParser;

/**
 The current text layout in text view (readonly).
 It can be used to query the text layout information.
 */
@property (nullable, nonatomic, strong, readonly) ZWTextLayout *textLayout;
 ...
 */
@property (nullable, nonatomic, copy) id<ZWTextLinePositionModifier> linePositionModifier;
...
UIKIT_EXTERN NSString *const ZWTextViewTextDidBeginEditingNotification;
UIKIT_EXTERN NSString *const ZWTextViewTextDidChangeNotification;
UIKIT_EXTERN NSString *const ZWTextViewTextDidEndEditingNotification;
