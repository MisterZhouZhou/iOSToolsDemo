 ...
 */
@interface ZWLabel : UIView <NSCoding>
 ...
 */
@property (nullable, nonatomic, strong) ZWTextLayout *textLayout;
...
/**
 ...
 The default value is nil.
 */
@property (nullable, nonatomic, copy) ZWTextAction textTapAction;

/**
 When user long press the label, this action will be called (similar to long press gesture).
 The default value is nil.
 */
@property (nullable, nonatomic, copy) ZWTextAction textLongPressAction;

/**
 When user tap the highlight range of text, this action will be called.
 The default value is nil.
 */
@property (nullable, nonatomic, copy) ZWTextAction highlightTapAction;

/**
 When user long press the highlight range of text, this action will be called.
 The default value is nil.
 */
@property (nullable, nonatomic, copy) ZWTextAction highlightLongPressAction;
