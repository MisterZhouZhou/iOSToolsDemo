...
- (void)reloadBounds {
    ...
    for (NSUInteger r = 0; r < runCount; r++) {
        ...
        ZWTextAttachment *attachment = attrs[ZWTextAttachmentAttributeName];
        if (attachment) {
            ...
            NSRange runRange = ZWNSRangeFromCFRange(CTRunGetStringRange(run));
