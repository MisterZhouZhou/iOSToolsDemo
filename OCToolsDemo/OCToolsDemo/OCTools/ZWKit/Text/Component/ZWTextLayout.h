...
#import <ZWKit/ZWTextDebugOption.h>
#import <ZWKit/ZWTextLine.h>
...
@protocol ZWTextLinePositionModifier;
 ...
 */
extern const CGSize ZWTextContainerMaxSize;
...
/**
 ...
 └─────────────────────────────┘
 */
@interface ZWTextContainer : NSObject <NSCoding, NSCopying>
...
@property ZWTextTruncationType truncationType;
...
@property (nullable, copy) id<ZWTextLinePositionModifier> linePositionModifier;
@end
 ...
 */
@protocol ZWTextLinePositionModifier <NSObject, NSCopying>
@required
/**
 ...
 */
- (void)modifyLines:(NSArray<ZWTextLine *> *)lines fromText:(NSAttributedString *)text inContainer:(ZWTextContainer *)container;
@end
 ...
 */
@interface ZWTextLinePositionSimpleModifier : NSObject <ZWTextLinePositionModifier>
...
/**
 ...
 └──────────────────────────┘
 */
@interface ZWTextLayout : NSObject <NSCoding>
 ...
 */
+ (nullable ZWTextLayout *)layoutWithContainerSize:(CGSize)size
...
/**
 ...
 @return A new layout, or nil when an error occurs.
 */
+ (nullable ZWTextLayout *)layoutWithContainer:(ZWTextContainer *)container
                                          text:(NSAttributedString *)text;
 ...
 */
+ (nullable NSArray<ZWTextLayout *> *)layoutWithContainers:(NSArray<ZWTextContainer *> *)containers
                                                      text:(NSAttributedString *)text;
...
///< The text container
@property (nonatomic, strong, readonly) ZWTextContainer *container;
///< The full text
...
@property (nonatomic, strong, readonly) NSArray<ZWTextLine *> *lines;
///< YYTextLine with truncated token, or nil
@property (nullable, nonatomic, strong, readonly) ZWTextLine *truncatedLine;
///< Array of `YYTextAttachment`
@property (nullable, nonatomic, strong, readonly) NSArray<ZWTextAttachment *> *attachments;
 ...
 */
- (nullable ZWTextPosition *)closestPositionToPoint:(CGPoint)point;
...
/**
 ...
 @return A text position, or nil if not found.
 */
- (nullable ZWTextPosition *)positionForPoint:(CGPoint)point
 ...
 */
- (nullable ZWTextRange *)textRangeAtPoint:(CGPoint)point;
...
/**
 ...
 at point. Or nil if not found.
 */
- (nullable ZWTextRange *)closestTextRangeAtPoint:(CGPoint)point;
 ...
 */
- (nullable ZWTextRange *)textRangeByExtendingPosition:(ZWTextPosition *)position;
 ...
 */
- (NSArray<ZWTextSelectionRect *> *)selectionRectsForRange:(ZWTextRange *)range;
...
/**
 ...
 If not found, the array is empty.
 */
- (NSArray<ZWTextSelectionRect *> *)selectionRectsWithoutStartAndEndForRange:(ZWTextRange *)range;
 ...
 */
- (NSArray<ZWTextSelectionRect *> *)selectionRectsWithOnlyStartAndEndForRange:(ZWTextRange *)range;
...
- (void)drawInContext:(nullable CGContextRef)context
                ...
                debug:(nullable ZWTextDebugOption *)debug
