...
@interface _ZWTextMagnifierCaret : ZWTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end

@implementation _ZWTextMagnifierCaret
...
- (ZWTextMagnifierType)type {
    return ZWTextMagnifierTypeCaret;
}
...
@interface _ZWTextMagnifierRanged : ZWTextMagnifier {
    UIImageView *_contentView;
    UIImageView *_coverView;
}
@end
...
@implementation _ZWTextMagnifierRanged
#define kMultiple 1.2
...
- (ZWTextMagnifierType)type {
    return ZWTextMagnifierTypeRanged;
}
...
@implementation ZWTextMagnifier

+ (id)magnifierWithType:(ZWTextMagnifierType)type {
    switch (type) {
        case ZWTextMagnifierTypeCaret :return [_ZWTextMagnifierCaret new];
        case ZWTextMagnifierTypeRanged :return [_ZWTextMagnifierRanged new];
    }
    return nil;
}
...
- (id)initWithFrame:(CGRect)frame {
    // class cluster
    if ([self isMemberOfClass:[ZWTextMagnifier class]]) {
