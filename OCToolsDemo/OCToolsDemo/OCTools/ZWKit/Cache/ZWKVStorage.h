 ...
 */
@interface ZWKVStorageItem : NSObject
 ...
 */
typedef NS_ENUM(NSUInteger, ZWKVStorageType) {
    
    /// The `value` is stored as a file in file system.
    ZWVStorageTypeFile = 0,
    
    /// The `value` is stored in sqlite with blob type.
    ZWKVStorageTypeSQLite = 1,
    
    /// The `value` is stored in file system or sqlite based on your choice.
    ZWKVStorageTypeMixed = 2,
};
 ...
 */
@interface ZWKVStorage : NSObject
...
@property (nonatomic, readonly) ZWKVStorageType type;  ///< The type of this storage.
 ...
 */
- (nullable instancetype)initWithPath:(NSString *)path type:(ZWKVStorageType)type NS_DESIGNATED_INITIALIZER;
 ...
 */
- (BOOL)saveItem:(ZWKVStorageItem *)item;
 ...
 */
- (nullable ZWKVStorageItem *)getItemForKey:(NSString *)key;
 ...
 */
- (nullable ZWKVStorageItem *)getItemInfoForKey:(NSString *)key;
 ...
 */
- (nullable NSArray<ZWKVStorageItem *> *)getItemForKeys:(NSArray<NSString *> *)keys;
...
/**
 ...
 @return An array of `YYKVStorageItem`, or nil if not exists / error occurs.
 */
- (nullable NSArray<ZWKVStorageItem *> *)getItemInfoForKeys:(NSArray<NSString *> *)keys;
