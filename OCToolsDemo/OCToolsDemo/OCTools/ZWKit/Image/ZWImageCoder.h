...
/**
 Image file type.
 */
typedef NS_ENUM(NSUInteger, ZWImageType) {
    ZWImageTypeUnknown = 0, ///< unknown
    ZWImageTypeJPEG,        ///< jpeg, jpg
    ZWImageTypeJPEG2000,    ///< jp2
    ZWImageTypeTIFF,        ///< tiff, tif
    ZWImageTypeBMP,         ///< bmp
    ZWImageTypeICO,         ///< ico
    ZWImageTypeICNS,        ///< icns
    ZWImageTypeGIF,         ///< gif
    ZWImageTypePNG,         ///< png
    ZWImageTypeWebP,        ///< webp
    ZWImageTypeOther,       ///< other image format
};
 ...
 */
typedef NS_ENUM(NSUInteger, ZWImageBlendOperation) {
 ...
 */
@interface ZWImageFrame : NSObject <NSCopying>
...
@property (nonatomic) ZWImageDisposeMethod dispose;     ///< Frame dispose method.
@property (nonatomic) ZWImageBlendOperation blend;      ///< Frame blend operation.
 ...
 */
@interface ZWImageDecoder : NSObject

@property (nullable, nonatomic, readonly) NSData *data;    ///< Image data.
@property (nonatomic, readonly) ZWImageType type;          ///< Image data type.
 ...
 */
- (nullable ZWImageFrame *)frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay;
 ...
 */
@interface ZWImageEncoder : NSObject

@property (nonatomic, readonly) ZWImageType type; ///< Image type.
 ...
 */
- (nullable instancetype)initWithType:(ZWImageType)type NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImage:(UIImage *)image type:(ZWImageType)type quality:(CGFloat)quality;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImageWithDecoder:(ZWImageDecoder *)decoder type:(ZWImageType)type quality:(CGFloat)quality;
...
@interface UIImage (ZWImageCoder)
 ...
 */
CG_EXTERN CGImageRef _Nullable ZWCGImageCreateDecodedCopy(CGImageRef imageRef, BOOL decodeForDisplay);
 ...
 */
CG_EXTERN CGImageRef _Nullable ZWCGImageCreateCopyWithOrientation(CGImageRef imageRef,
...
/**
 ...
 @return A new image, or NULL if an error occurs.
 */
CG_EXTERN CGImageRef _Nullable ZWCGImageCreateAffineTransformCopy(CGImageRef imageRef,
 ...
 */
CG_EXTERN CFDataRef _Nullable ZWCGImageCreateEncodedData(CGImageRef imageRef, ZWImageType type, CGFloat quality);


/**
 Whether WebP is available in YYImage.
 */
CG_EXTERN BOOL ZWImageWebPAvailable();
 ...
 */
CG_EXTERN NSUInteger ZWImageGetWebPFrameCount(CFDataRef webpData);
 ...
 */
CG_EXTERN CGImageRef _Nullable ZWCGImageCreateWithWebPData(CFDataRef webpData,
                                                           BOOL decodeForDisplay,
                                                           BOOL useThreads,
                                                           BOOL bypassFiltering,
                                                           BOOL noFancyUpsampling);

typedef NS_ENUM(NSUInteger, ZWImagePreset) {
    ZWImagePresetDefault = 0,  ///< default preset.
    ZWImagePresetPicture,      ///< digital picture, like portrait, inner shot
    ZWImagePresetPhoto,        ///< outdoor photograph, with natural lighting
    ZWImagePresetDrawing,      ///< hand or line drawing, with high-contrast details
    ZWImagePresetIcon,         ///< small-sized colorful images
    ZWImagePresetText          ///< text-like
};
 ...
 */
CG_EXTERN CFDataRef _Nullable ZWCGImageCreateEncodedWebPData(CGImageRef imageRef,
                                                             BOOL lossless,
                                                             CGFloat quality,
                                                             int compressLevel,
                                                             ZWImagePreset preset);
